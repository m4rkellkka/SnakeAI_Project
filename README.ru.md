...
- Более долгие тренировки сверх текущего чекпойнта на 275 играх
...
- Анимированный GIF с игрой обученного агента в самом верху README (использовать существующий `tools/record_demo.py`)
